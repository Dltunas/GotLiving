...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="" class="logo d-flex align-items-center">
        <img src="{{url('bootstrap/assets/img/logo.png')}}" alt="">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{url('bootstrap/assets/img/profile-img.jpg')}}" alt="Profile" class="rounded-circle">
  ...
  <!-- Vendor JS Files -->
  <script src="vendor/bootstrap/assets/vendor/apexcharts/apexcharts.min.js"></script>
  <script src="vendor/bootstrap/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="vendor/bootstrap/assets/vendor/chart.js/chart.min.js"></script>
  <script src="vendor/bootstrap/assets/vendor/echarts/echarts.min.js"></script>
  <script src="vendor/bootstrap/assets/vendor/quill/quill.min.js"></script>
  <script src="vendor/bootstrap/assets/vendor/simple-datatables/simple-datatables.js"></script>
  <script src="vendor/bootstrap/assets/vendor/tinymce/tinymce.min.js"></script>
  <script src="vendor/bootstrap/assets/vendor/php-email-form/validate.js"></script>

  <!-- Template Main JS File -->
  <script src="vendor/bootstrap/assets/js/main.js"></script>
